...
- Sends a **weekly summary** (Friday 3pm EST) including:
  - total messages
  - top posters
  - AI-generated recap (optional, via Google Gemini free tier)
- Tracks bets between group members (`/bet`, `/bets`, `/settlebet`)
- Backs up the database weekly
- Prunes old messages monthly
- Supports multiple group chats independently
...
OTLCBot-2.0/
├── src/
│ ├── bot.py # Main bot (message logging, commands, bets)
...
- TELEGRAM_BOT_TOKEN
- TELEGRAM_CHAT_ID (comma-separated for multiple groups)
- DB_PATH (default: /opt/otlc/data.db)

Optional:

- GEMINI_API_KEY (for AI-powered weekly recap)
- ENABLE_AI_SUMMARY (default: false)
...
| `/bet` | Create a new bet (guided conversation) |
...
# Weekly summary (Friday 3pm EST)
0 15 * * 5 /home/parker/OTLCBot-2.0/.venv/bin/python /home/parker/OTLCBot-2.0/src/weekly.py >> /home/parker/OTLCBot-2.0/weekly.log 2>&1
...
- AI summaries are optional and use Google Gemini free tier.
- Bets are kept forever (not pruned).
